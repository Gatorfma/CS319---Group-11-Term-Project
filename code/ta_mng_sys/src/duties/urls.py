...
from .views import manage_duty_logs, auto_assign_proctors_view, assign_classrooms_view, delete_exam_assignments_view, edit_exam_assignment_view, manage_exam_assignments_view, manual_assign_proctors_view, select_exam_for_manual_assignment, log_completed_duty
app_name = "duties"
